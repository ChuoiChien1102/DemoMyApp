...
class _AppService implements AppService {
  ...
  @override
  Future<HttpResponse<BaseResponse<List<Event>>>> getListEvent() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<BaseResponse<List<Event>>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<List<Event>> _value;
    try {
      _value = BaseResponse<List<Event>>.fromJson(
        _result.data!,
